...
<div class="register-wrapper">
  ...
  <?php
    $id = $member->id;
  ?>
<form action="/admin/anggota/{{ $id }}/update" method="POST" class="form login" autocomplete="on">
        {{ method_field('PATCH') }}
        {{ csrf_field() }}
        ...
        <select class="form__input" name="level">
          ...
          <option <?php if ($member->level != "A") echo "selected='selected'";?>>Member</option>
          <option value="A" <?php if ($member->level == "A") echo "selected='selected'";?>>Admin</option>
        </select>
      </div>
